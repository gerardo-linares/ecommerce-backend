export const productErrorIncompleteValues = (product) => {
  ...
  * department: se esperaba una cadena definida, y se recibió '${product.category}',
...
export const productErrorInvalidTypes = (product) => {
  ...
  * price: se esperaba un número no negativo, y se recibió '${
    typeof product.price === "number" ? product.price : "caracter inválido"
  }',
  * department: se esperaba una cadena de caracteres, y se recibió '${typeof product.category}',
  * stock: se esperaba un número no negativo y entero, y se recibió '${
    typeof product.stock === "number" ? product.stock : "caracter inválido"
  }',
